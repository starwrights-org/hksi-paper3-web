...
export default function QuizPage({ params }: { params: Promise<{ chapterId: string }> }) {
  ...
  const chapterInfo = [...chapters, ...mockExams].find(c => c.id === resolvedParams.chapterId);

  useEffect(() => {
    async function loadQuestions() {
      try {
        const res = await fetch(`/data/${resolvedParams.chapterId}.md`);
    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <div className="flex justify-between items-center mt-2">
            <h1 className="text-xl font-bold text-gray-900">
              {chapterInfo?.name || resolvedParams.chapterId}
            </h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <div className="text-lg text-gray-900 mb-6 leading-relaxed whitespace-pre-wrap">
            {questionTitle}
          </div>
